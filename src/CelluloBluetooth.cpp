...
void CelluloBluetooth::actOnZoneCalculateChanged(const QString& key, float value){
    ...
    //SIGNAL send zone type, value
    //check case robot not connected
    zonesChangesHandler.clear();
    if(key == macAddr){
        CelluloZone* obj = static_cast<CelluloZone *>(sender());
        //TODO check if dynamic cast needed
        switch (obj->getType()) {
        ...
        case CelluloZoneTypes::RECTANGLEBORDER:
            ...
            //                break;
            //            case CelluloZoneTypes::LINEBORDER:
            //                break;
        ...
        //TODO check if not more logical to have value -> make it a map!
